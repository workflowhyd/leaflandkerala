      ...
      data: {
        ...
        employee: {
          create: {
            ...
            governmentIdType: registrationRequest.governmentIdType,
            governmentIdNumber: registrationRequest.governmentIdNumber,
            governmentIdFrontUrl: registrationRequest.governmentIdFrontUrl,
            governmentIdFrontPublicId: registrationRequest.governmentIdFrontPublicId,
            governmentIdBackUrl: registrationRequest.governmentIdBackUrl,
            governmentIdBackPublicId: registrationRequest.governmentIdBackPublicId,
          },
        },
      },
